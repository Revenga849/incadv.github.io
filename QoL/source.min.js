...
var __0x41dc23 = _0x41dc23;\n\
var addLog = function(id, text) {\n\
	__0x41dc23(id, text);\n\
	if (typeof _0x2a2e9b.options !==  "undefined" && typeof _0x2a2e9b.options[id] !==  "undefined" && _0x2a2e9b.options[id] ==  0)\n\
        return;\n\
	var logtext = _0x2a2e9b.combatLog[_0x2a2e9b.combatLog.length-1];\n\
	logs.push(logtext);\n\
	if (logs.length > 500) {\n\
		logs.shift();\n\
	}\n\
...
\n\
	...
	div.setAttribute("style", "overflow:auto; text-align: right;");\n\
	qoldiv.append(div);\n\
\n\
...
\n\
function initLogs() {\n\
	for (let i = 0; i < _0x2a2e9b.combatLog.length; i++) {\n\
		var logtext = _0x2a2e9b.combatLog[i];\n\
		logs.push(logtext);\n\
		var divlog = document.getElementById("qol-logs");\n\
		var p = document.createElement("p");\n\
		p.setAttribute("class", "combat-log-record");\n\
...
function redraw() {\n\
	...
	if (prestigePoints.length != prestiges.childElementCount) {\n\
		if (__init) {\n\
			...
			prestiges.setAttribute("style", "overflow:auto; text-align: right;");\n\
\n\
			var divlog = document.createElement("div");\n\
			divlog.setAttribute("id","qol-logs");\n\
			divlog.setAttribute("style", "overflow:auto; width:60vw; height: 18vw; bottom: 0vw; right: 0; position: fixed; text-align: center; display:none;");\n\
		...
		for (let i = 0; i < prestigePoints.length; i++) {\n\
			...
			\n\
			button.setAttribute("onclick", "prestige(" + i + ");_0x3ba495();");\n\
			p.append(button);\n\
			\n\
			prestiges.append(p);\n\
		}\n\
...
function toggleForceFormat() {\n\
	...
	_0x2d3eb5 = forceFormat?formatValue:_renderNumber;\n\
...
function getMult(i) {\n\
	...
	prestigePoints = _0x1e849d();\n\
	if (_0x2a2e9b.prestige != undefined && _0x2a2e9b.prestige[i] != undefined) {\n\
		mult = new Decimal(1);\n\
		var pstats = _0x2a2e9b.prestige[i][1];\n\
		var upgradePoints = _0x223db1(pstats);\n\
		upgradePoints = upgradePoints.plus(prestigePoints[i]\n\
				.divideBy(5)\n\
				.floor());\n\
		if (_0x4bfb60(upgradePoints).cmp(_0x4bfb60(pstats.add(1)))>=0) {\n\
			mult = _0x4bfb60(upgradePoints)\n\
				.plus(1)\n\
		...
		if (upgradePoints.cmp(0) > 0) {\n\
			mult = mult.multiply(_0x4bfb60(upgradePoints).plus(1));\n\
		}\n\
	}\n\
	return mult;\n\
}\n\
...
function getCur(i) {\n\
	...
	if (_0x2a2e9b.prestige != undefined && _0x2a2e9b.prestige[i] != undefined) {\n\
		cur = _0x2a2e9b.prestige[i][1].plus(1).multiply(i>0?i:1);\n\
	}\n\
	return cur;\n\
}\n\
\n\
...
var sInterval = setInterval(function() {\n\
	...
	for (var i = 0; i < prestigePoints.length; i++) {\n\
		...
		if (typeof _0x2a2e9b.prestige !== "undefined") {\n\
			setTotalsText(formatValue(_0x2a2e9b.prestige.reduce((a,b,c)=>a.multiply(b[1].add(1).multiply(c>0?c:1)), new Decimal(1))));\n\
		} else {\n\
			setTotalsText(1);\n\
		}\n\
	}\n\
