...
function openCalcPL() {\n\
	...
	if (gameState.ascension != undefined && gameState.ascension[0] != undefined) {\n\
		if (gameState.ascension[0][7] != null)\n\
			rppr = gameState.ascension[0][7];\n\
		if (gameState.ascension[0][8] != null)\n\
			rpdr = gameState.ascension[0][8];\n\
	}\n\
...
function openCalcAL() {\n\
	...
	var acu = "0";\n\
	if (gameState.ascension != undefined && gameState.ascension[0] != undefined) {\n\
		acp = gameState.ascension[0][0];\n\
		acu = gameState.ascension[0][1];\n\
	}\n\
	url += "?acp="+acp+"&acu="+acu;\n\
	window.open(url);\n\
}\n\
...
function openCalcAL() {\n\
	...
	atp = formatValue(atp.add(20));\n\
	url += "?a1cp="+a1cp+"&a1cu="+a1cu+"&atp="+atp+"&iapg="+iapg;\n\
	window.open(url);\n\
}\n\
\n\
var theme = gameState.options[0];\n\
